import { getJsonResponse, post } from './http_help.js';
...
var spotifyTopTracks = new Vue({
    ...
    methods: {
        downloadTopTracks: function () {
            ...
            this.hasFetchedTracks = true;
        },

        exportToPlaylist: function (playlistName) {
            if (this.createdPlaylists == null) {
                this.createdPlaylists = [];
            }
            this.hasCreatedPlaylist = false;
            let name = 'most popular tracks in ' + this.timeframe;
            if (this.createdPlaylists.includes(name)) {
                return; //simple way of not creating many duplicate playlists
            }
            this.createdPlaylists.push(name);
            ...
            profileResponse.then(profile => {
                ...
                let playlistRequest = {
                    'name': 'most popular tracks in ' + this.timeframe,
                    'public': false
                };
